   ...
   /**
    ...
    define_suit() {
        ...
        for (var i = 0; i < NUM_SUITES; i++) {
          for (var j = 0; j < SUITES_PER_DECK; j++) {
            var index = (i * SUITES_PER_DECK) + j;
    ...
    define_value(){
        ...
        while (suite_ct < suites.length) {
            suit = this.suit[suite_ct];
            this.card_map.add(card_key, ("A of " + suit));
            card_key++;
            this.card_map.add(card_key, ("A of " + suit));
            card_key++;
            this.card_map.add(card_key, "2 of " + suit);
            card_key++;
            this.card_map.add(card_key, "3 of " + suit);
            card_key++;
            this.card_map.add(card_key, "4 of " + suit);
            card_key++;
            this.card_map.add(card_key, "5 of " + suit);
            card_key++;
            this.card_map.add(card_key, "6 of " + suit);
            card_key++;
            this.card_map.add(card_key, "7 of " + suit);
            card_key++;
            this.card_map.add(card_key, "8 of " + suit);
            card_key++;
            this.card_map.add(card_key, "9 of " + suit);
            card_key++;
            this.card_map.add(card_key, "10 of " + suit);
            card_key++;
            this.card_map.add(card_key, "J of " + suit);
            card_key++;
            this.card_map.add(card_key, "2 of " + suit);
            card_key++;
            this.card_map.add(card_key, "3 of " + suit);
            ...
            this.card_map.add(card_key, "J of " + suit);
            card_key++;
            this.card_map.add(card_key, "Q of " + suit);
            card_key++;
            this.card_map.add(card_key, "Q of " + suit);
            card_key++;
            this.card_map.add(card_key, "K of " + suit);
            card_key++;
            this.card_map.add(card_key, "K of " + suit);
            card_key++;
            i++;
    //                System.out.printf("HERE %d%n", card_index);
        ...
        print_card_map(){
            for(var i = 0; i < this.card_map.length; i++){
                console.log(this.card_map[i]);
            }
        }
